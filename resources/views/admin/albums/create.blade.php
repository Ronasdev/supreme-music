...
<div class="d-flex align-items-center mb-4">
    <h2><i class="fas fa-plus-circle me-2"></i>Ajouter un nouvel album</h2>
</div>
...
<div class="card shadow-sm">
    ...
    <div class="mb-3">
            ...
            <div class="mb-4">
                ...
                <small class="text-muted">Format recommandé: JPG ou PNG, 500x500px minimum</small>
            </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save me-1"></i> Créer l'album
                </button>
            </div>
        </form>
    </div>
