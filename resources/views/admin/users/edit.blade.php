        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="alert alert-warning mt-2">
                    <i class="fas fa-exclamation-triangle me-2"></i>Attention : vous modifiez votre propre compte. Si vous retirez vos droits d'administration, vous perdrez l'accès à cette interface.
                </div>
                @endif
            </div>
